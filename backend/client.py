...
# Configuration
SERVER_URL = 'http://192.168.74.42:5000'  # Replace with your server's IP address
CLIENT_ID = 'client1'  # Example client ID
NETWORK_SHARED_DIR = r'\\192.168.74.42\SharedDatasets'  # Replace with your server's IP address
